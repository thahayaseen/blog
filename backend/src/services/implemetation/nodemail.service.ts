...
import NodemailDto from "@/dtos/nodemail.dto";
import { IMailProvider } from "@/provider/interface/Inodemail.provider";
 ...
 <body>
     <center>
      ...
      throw createHttpError(
        ...
        error instanceof Error ? error.message : "Un able to send the mail"
      );
    }
  }
}
